	...
	<div class="container-fluid" id="wrapper">
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
				<h1 class="site-title"><em class="fa fa-rocket"></em> Seguimiento de Proceso</a></h1>
				
				<a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><em class="fa fa-bars"></em></a>
				
				<ul class="nav nav-pills flex-column sidebar-nav">
                                    <li class="nav-item"><a class="nav-link active" href="usuarios"><em class="fa fa-calendar-o"></em> Usuarios <span class="sr-only">(current)</span></a></li>
				    <li class="nav-item"><a class="nav-link" href="procesos"><em class="fa fa-calendar-o"></em> Procesos</a></li>
                                    <li class="nav-item"><a class="nav-link" href="movimientos"><em class="fa fa-calendar-o"></em> Movimientos</a></li>
			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Seguimiento de Proceso</h1>
					</div>
						...
						<div class="dropdown-menu dropdown-menu-right" style="margin-right: 1.5rem;" aria-labelledby="dropdownMenuLink">
						     ...
						     <a class="dropdown-item" href="{{ route('logout') }}"
                                            onclick="event.preventDefault();
                                                     document.getElementById('login-form').submit();"><em class="fa fa-power-off mr-1"></em> Logout</a>
